...
/**
 * UserService should hold business logic
 * <p>
 * In Spring, dependency injection can be done via setter methods, and this is an example of that.
 * In this case, the UserDao userDao is a dependency of the UserService class
 * <p>
 ...
 * method to inject it into the UserService class as a dependency
 * <p>
 * This way the UserService doesn't need to manually create or look for a UserDao instance;
...
public class UserService {
    ...
    private List<ObjectNode> loadingJsonDataFromFile() {
        ...
        InputStream jsonData = UserService.class.getResourceAsStream("/Users.json");
        try {
